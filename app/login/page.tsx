      ...
      >
         ...
         >
          ...
          <div className="relative w-full h-full px-4 sm:px-6 md:px-8 lg:px-[155px] py-3 sm:py-4 md:py-5 lg:py-8 flex flex-col justify-center items-center lg:items-center">
            ...
            {/* Divider */}
            <motion.div 
              className="mt-4 sm:mt-5 md:mt-6 w-full lg:w-[514px] lg:mx-auto flex items-center gap-3 sm:gap-4"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            <motion.button
              ...
              className="mt-4 sm:mt-5 md:mt-6 w-full lg:w-[514px] lg:mx-auto h-11 sm:h-12 md:h-14 lg:h-16 bg-white border-[0.5px] border-[#C2C2C2] rounded-full sm:rounded-[90px] font-semibold text-sm sm:text-base md:text-[16.0016px] flex items-center justify-center gap-3 shadow-md hover:shadow-lg transition-all duration-300 hover:bg-gray-50 touch-manipulation"
              whileHover={{ 
                scale: 1.02,
